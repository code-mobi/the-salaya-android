...
public class StoreAdapter extends ArrayAdapter<String> {
	...
	private static LayoutInflater mInflater = null;
	  ...
	  public StoreAdapter(Activity activity,int resource, String[] titles, String[] descriptions) {
	  ...
	  public View getView(int position, View convertView, ViewGroup parent) {
			...
			if (convertView == null) {
				...
				holder.title_tv = (TextView) convertView
						.findViewById(R.id.title_store_tv);
				holder.description_tv = (TextView) convertView
						.findViewById(R.id.description_store_tv);
				holder.thumbnail_imv = (ImageView) convertView
						.findViewById(R.id.thumb_store_imgview);
