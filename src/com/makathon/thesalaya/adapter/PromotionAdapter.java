...
public class PromotionAdapter extends ArrayAdapter<String> {
	...
	public PromotionAdapter(Activity activity, int resource, String[] titles,
			String[] descriptions) {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if (convertView == null) {
			...
			holder.title_tv = (TextView) convertView
					.findViewById(R.id.title_promotion_tv);
			holder.description_tv = (TextView) convertView
					.findViewById(R.id.description_promotion_tv);
			holder.thumbnail_imv = (ImageView) convertView
					.findViewById(R.id.thumb_promotion_imgview);
